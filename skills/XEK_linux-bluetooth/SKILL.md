...
objetivo: >
  BlueZ · pairings · firmware updates · scan rogue.
...
modos_ejecucion:
  ...
  sandbox:
    ...
    efectos_disco: "solo bajo $XDG_RUNTIME_DIR/xek-sandbox/XEK_linux-bluetooth/"
    efectos_red: "TODO"
    salida: "findings.json en sandbox"
  real:
    proposito: "TODO"
    precondicion: "sandbox del mismo input ha pasado en las últimas 24h"
    efectos_disco: "cuaderno/artefactos/XEK_linux-bluetooth/<fecha>/"
    efectos_red: "TODO"
...
migracion_runtime:
  bash:   scripts/xek-linux-bluetooth.sh
  python: scripts/xek-linux-bluetooth.py
  zsh:    scripts/xek-linux-bluetooth.zsh
...
- [ ] Implementar `scripts/xek-linux-bluetooth.sh` con los 3 modos

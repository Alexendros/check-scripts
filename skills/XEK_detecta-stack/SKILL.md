...
objetivo: >
  app-en-vivo|host|emite manifiesto v2 con stack/host_huellas detectados.
...
modos_ejecucion:
  ...
  real:
    ...
    efectos_disco: "cuaderno/artefactos/XEK_detecta-stack/<fecha>/"
    efectos_red: "TODO"
...
- [ ] Implementar `scripts/xek-detecta-stack.sh` con los 3 modos

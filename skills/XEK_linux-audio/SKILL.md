...
objetivo: >
  servidor audio · sample rate · grupos audio.
...
modos_ejecucion:
  ...
  sandbox:
    ...
    efectos_disco: "solo bajo $XDG_RUNTIME_DIR/xek-sandbox/XEK_linux-audio/"
    efectos_red: "TODO"
    salida: "findings.json en sandbox"
  real:
    proposito: "TODO"
    precondicion: "sandbox del mismo input ha pasado en las últimas 24h"
    efectos_disco: "cuaderno/artefactos/XEK_linux-audio/<fecha>/"
    efectos_red: "TODO"
...
migracion_runtime:
  bash:   scripts/xek-linux-audio.sh
  python: scripts/xek-linux-audio.py
  zsh:    scripts/xek-linux-audio.zsh
...
- [ ] Implementar `scripts/xek-linux-audio.sh` con los 3 modos

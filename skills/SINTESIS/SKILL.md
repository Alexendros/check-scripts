...
objetivo: >
  skill propia del rol IA-síntesis · merge tesis+antítesis → v(N+1) con diff trazable.
...
modos_ejecucion:
  ...
  sandbox:
    ...
    efectos_disco: "solo bajo $XDG_RUNTIME_DIR/xek-sandbox/SINTESIS/"
    efectos_red: "TODO"
    salida: "findings.json en sandbox"
  real:
    proposito: "TODO"
    precondicion: "sandbox del mismo input ha pasado en las últimas 24h"
    efectos_disco: "cuaderno/artefactos/SINTESIS/<fecha>/"
    efectos_red: "TODO"
...
migracion_runtime:
  bash:   scripts/sintesis.sh
  python: scripts/sintesis.py
  zsh:    scripts/sintesis.zsh
...
- [ ] Implementar `scripts/sintesis.sh` con los 3 modos
